...
const featured = [
  ...
  },
  {
    ...
    algo: "DQN",            accent: "#4488ff",
    desc: "Q-value chart live every frame",
    descFr: "Graphique Q-value en direct",    descAr: "مخطط Q-value يتحدث لحظياً",
  },
  {
    id: "car-racing",
    icon: "🏎️",
    ...
    desc: "30 cars, 8 raycast sensors",
    descFr: "30 voitures, 8 capteurs raycasts", descAr: "30 سيارة، 8 مستشعرات",
  },
  {
    id: "game-2048",
    icon: "🔢",
    ...
    desc: "80 simulations per move",
    descFr: "80 simulations par mouvement",   descAr: "80 محاكاة لكل حركة",
  },
];
